...
//  particle_gun_->SetParticleMomentumDirection(G4ThreeVector(0.0,0.0,1.0));
  ...
  G4double pos_y = 7.1 * sin(theta) * sin(phi) * micrometer;
  G4double pos_z = 2.5 * cos(theta) * micrometer;
  particle_gun_->SetParticleMomentumDirection(G4ThreeVector(0.0, 0.0, 0.0) - G4ThreeVector(pos_x, pos_y, pos_z));
